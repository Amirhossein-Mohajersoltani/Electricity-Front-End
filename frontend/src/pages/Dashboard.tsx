...
const Dashboard = () => {
  ...
  const companyLabel = companyType === 'private' ? 'شرکت خصوصی' : 'شرکت عمومی'
  const badgeColor = companyType === 'private' ? 'purple' : 'blue'
      ...
      <div className="max-w-full mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="mb-4 lg:mb-0">
                ...
                <p className="text-gray-600">
                  {companyType === 'private' ? 'داشبورد مدیریت مصرف انرژی شرکت' : 'داشبورد شرکت توزیع نیروی برق'}
                </p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            >
              <div className="w-12 h-12 bg-blue-600 rounded-lg flex items-centerjustify-center mb-3 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <span className="text-sm font-medium text-gray-900">
                {companyType === 'private' ? 'تحلیل مصرف برق' : 'تحلیل فیدر'}
              </span>
            </button>
        ...
        {/* Guide Section */}
        <div className="mt-8">
          {companyType === 'private' ? <PrivateCompanyGuide /> : <RegionFeederGuide />}
        </div>
      </div>
    </div>
  )
