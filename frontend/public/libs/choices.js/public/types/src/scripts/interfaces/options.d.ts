 ...
 * **Terminology**
 *
 * - **Choice:** A choice is a value a users can select. A choice would be equivalent to the `<option></option>` element within a select input.
...
export interface Options {
    ...
    choices: InputChoice[];
    /**
     * The amount of choices to be rendered within the dropdown list `("-1" indicates no limit)`. This is useful if you have a lot of choices where it is easier for a users to use the search area to find a choice.
     *
     * **Input types affected:** select-one, select-multiple
     *
     * @default -1
    ...
    /**
     * The amount of items a users can input/select `("-1" indicates no limit)`.
     *
    ...
    /**
     * Whether a users can add choices dynamically.
     *
     * **Input types affected:** select-one, select-multiple
     *
     * @default false
    ...
    addItems: boolean;
    /**
     * A filter that will need to pass for a users to successfully add an item.
     *
    ...
    /**
     * The text that is shown when a users has inputted a new item but has not pressed the enter key. To access the current input value, pass a function with a `value` argument (see the **default config** [https://github.com/jshjohnson/Choices#setup] for an example), otherwise pass a string.
    ...
    /**
     * Whether a users can remove items.
     *
     * **Input types affected:** text, select-multiple
     *
     * @default true
    ...
    /**
     * Whether a users can edit items. An item's value can be edited by pressing the backspace.
     *
     * **Input types affected:** text
     *
     * @default false
     ...
     * If `false`, users input will be treated as plain text.
    ...
    delimiter: string;
    /**
     * Whether a users can paste into the input.
     *
     * **Input types affected:** text, select-multiple
     *
     * @default true
    ...
    /**
     * Specify which fields should be used when a users is searching. If you have added custom properties to your choices, you can add these values thus: `['label', 'value', 'customProperties.example']`.
     *
     * Input types affected:select-one, select-multiple
     *
     * @default ['label', 'value']
    ...
    /**
     * The function that will sort choices and items before they are displayed (unless a users is searching). By default choices and items are sorted by alphabetical order.
     *
     * **Input types affected:** select-one, select-multiple
     *
     * @example
    ...
    loadingText: string;
    /**
     * The text that is shown when a users's search has returned no results. Optionally pass a function returning a string.
     *
     * **Input types affected:** select-one, select-multiple
     *
    ...
    /**
     * The text that is shown when a users has selected all possible choices, or no choices exist. Optionally pass a function returning a string.
     *
    ...
    /**
     * The text that is shown when a users hovers over a selectable choice. Set to empty to not reserve space for this text.
     *
     * **Input types affected:** select-multiple, select-one
     *
    ...
    /**
     * The text that is shown when a users has focus on the input but has already reached the **max item count** [https://github.com/jshjohnson/Choices#maxitemcount]. To access the max item count, pass a function with a `maxItemCount` argument (see the **default config** [https://github.com/jshjohnson/Choices#setup] for an example), otherwise pass a string.
     *
     * **Input types affected:** text
     *
     * @default
