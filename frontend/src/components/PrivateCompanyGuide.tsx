        ...
        <div className="flex-1">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  به عنوان شرکت خصوصی، شما به طور خودکار به داده‌های مربوط به خط تولید و مصرف انرژی خود دسترسی دارید.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4 p-4 bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg">
            ...
            <p className="text-sm text-gray-700">
              برای شروع تحلیل، روی یکی از گزینه‌های "تحلیل فیدر" یا "مقایسه انرژی" کلیک کنید و سپس بازه زمانی مورد نظر را انتخاب کنید.
            </p>
          </div>
        </div>
      </div>
