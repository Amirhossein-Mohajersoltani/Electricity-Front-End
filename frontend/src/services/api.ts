...
class ApiService {
  ...
  /**
   * Get energy comparison data from FilterRequest
   */
  async getEnergyComparisonFromFilter(params: FilterRequest): Promise<ApiResponse<{ energy_comparison: EnergyComparisonResponse }>> {
  ...
  /**
   * Get energy comparison with custom filter data
   */
  async getEnergyComparisonWithFilter(
    filterData: {
      id: string;
      name: string;
      regions: string[];
    ...
    const request = {
      ...
      feeders: filterData.feeders,
      color: filterData.color,
      rangeType: filterData.rangeType,
      startDate: filterData.startDate,
      endDate: filterData.endDate,
      customDays: filterData.customDays
    };
...
export const backendApiService = {
  ...
  getEnergyComparison: api.getEnergyComparisonFromFilter.bind(api), // تغییر نام شده
